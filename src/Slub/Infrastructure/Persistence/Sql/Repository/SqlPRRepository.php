...
SQL;
    ...
    {
        $sql = <<<SQL
SELECT IDENTIFIER, GTMS, NOT_GTMS, COMMENTS, CI_STATUS, IS_MERGED, MESSAGE_IDS, PUT_TO_REVIEW_AT, CHANNEL_IDS, WORKSPACE_IDS, AUTHOR_IDENTIFIER, TITLE, CLOSED_AT, IS_LARGE
FROM pr
...
SQL;
    ...
    private function hydrate(array $result): PR
    {
        ...
        $result['IS_LARGE'] = Type::getType(Type::BOOLEAN)->convertToPhpValue(
            $result['IS_LARGE'],
            $this->sqlConnection->getDatabasePlatform()
        );
    ...
    private function updatePR(PR $PR): void
    {
        $sql = <<<SQL
INSERT INTO
  pr (IDENTIFIER, GTMS, NOT_GTMS, COMMENTS, CI_STATUS, IS_MERGED, MESSAGE_IDS, PUT_TO_REVIEW_AT, CHANNEL_IDS, WORKSPACE_IDS, AUTHOR_IDENTIFIER, TITLE, CLOSED_AT, IS_LARGE)
VALUES
  (:IDENTIFIER, :GTMS, :NOT_GTMS, :COMMENTS, :CI_STATUS, :IS_MERGED, :MESSAGE_IDS, :PUT_TO_REVIEW_AT, :CHANNEL_IDS, :WORKSPACE_IDS, :AUTHOR_IDENTIFIER, :TITLE, :CLOSED_AT, :IS_LARGE)
