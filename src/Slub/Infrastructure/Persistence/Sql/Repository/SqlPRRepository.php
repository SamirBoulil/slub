...
SQL;
    ...
    {
        $sql = <<<SQL
SELECT IDENTIFIER, GTMS, NOT_GTMS, COMMENTS, CI_STATUS, IS_MERGED, MESSAGE_IDS, PUT_TO_REVIEW_AT, MERGED_AT, CHANNEL_IDS, AUTHOR_IDENTIFIER, TITLE
FROM pr
...
SQL;
    ...
    private function updatePR(PR $PR): void
    {
        $sql = <<<SQL
INSERT INTO
  pr (IDENTIFIER, GTMS, NOT_GTMS, COMMENTS, CI_STATUS, IS_MERGED, MESSAGE_IDS, PUT_TO_REVIEW_AT, MERGED_AT, CHANNEL_IDS, AUTHOR_IDENTIFIER, TITLE)
VALUES
  (:IDENTIFIER, :GTMS, :NOT_GTMS, :COMMENTS, :CI_STATUS, :IS_MERGED, :MESSAGE_IDS, :PUT_TO_REVIEW_AT, :MERGED_AT, :CHANNEL_IDS, :AUTHOR_IDENTIFIER, :TITLE)
