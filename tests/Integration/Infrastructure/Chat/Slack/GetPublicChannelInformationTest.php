...
class GetPublicChannelInformationTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->getPublicChannelInformation = new GetPublicChannelInformation($client, 'xobxob-slack-token');
    }
    ...
    public function it_calls_the_slack_api_to_retrieve_the_channel_information()
    {
        ...
        $channelInformation = $this->getPublicChannelInformation->fetch('1231461');
    ...
    public function it_throws_if_the_http_status_is_not_200()
    {
        ...
        $this->getPublicChannelInformation->fetch('1231461');
    }
