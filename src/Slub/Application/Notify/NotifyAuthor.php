...
class NotifyAuthor implements EventSubscriberInterface
{
    ...
    public const MESSAGE_CI_RED = ':octagonal_sign: CI Failed ' . self::PLACEHOLDER_BUILD_LINK;
    ...
    {
        $gtmedMessage = str_replace(self::PLACEHOLDER_REVIEWER_NAME, $event->reviewerName()->stringValue(), self::MESSAGE_PR_GTMED);
    ...
    {
        $notGtmedMessage = str_replace(self::PLACEHOLDER_REVIEWER_NAME, $event->reviewerName()->stringValue(), self::MESSAGE_PR_NOT_GTMED);
    ...
    {
        $commentedMessage = str_replace(self::PLACEHOLDER_REVIEWER_NAME, $event->reviewerName()->stringValue(), self::MESSAGE_PR_COMMENTED);
    ...
    {
        $redCIMessage = str_replace(self::PLACEHOLDER_BUILD_LINK, $event->buildLink()->stringValue(), self::MESSAGE_CI_RED);
